...
class SegmentoPBradesco extends SegmentoPGenerico
{
    use DadosBancarios;
    ...
    {
        $nossoNumero = $this->getCarteira() . sprintf("%011d", $this->nossoNumero);
    ...
    public function criaLinha()
    {
        ...
        //pos[41-45] - 5
        $linha .= sprintf(str_pad('', 5, '0'));
        //pos[46-57] - 12 nosso número + dv
